...
namespace sample_design_patterns
{
    ...
    public abstract class TemplatePipelineAsCode
    {
        ...
        //In this function the correct compiler is used, e.g.: tsc or coffe
        ...
        //In this step static policies can be verified, e.g.: with OPA or 
        public abstract void RunPolicyAsCode();
        public abstract void PackageAssets();
        public abstract void Deploy();
        //Depending on the domain this migth include Unit Test,  BDD with behave, etc
